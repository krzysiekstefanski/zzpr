...
const Heading = ({ className, text, children, size, color, center, align, pb, pbLG, mr, mb, mbMD, underline }) => (
  <Title as={size ? `h${size}` : null} className={className} color={color} center={center} align={align} pb={pb} pbLG={pbLG} mr={mr} mb={mb} mbMD={mbMD} underline={underline}>
