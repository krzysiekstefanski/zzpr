...
const Text = ({ className, text, children, typography, linkTypography, color, center, align, alignMD, pl, pr, m, mb, mbMD }) => (
  <Paragraph className={className} typography={typography} linkTypography={linkTypography} color={color} center={center} align={align} alignMD={alignMD} pl={pl} pr={pr} m={m} mb={mb} mbMD={mbMD}>
